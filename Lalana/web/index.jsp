...
<div class="container">
        <div class="card p-5">
            <div class="card-body">
                 <h5 class="card-title">INSERTION LALANA</h5>
                 <form method="GET" action="InsertPatient">
                    ...
                    <div class="row ">
                        <div class="input-group mb-3  col-lg-12">
                            ...
                            <select class="form-select" id="article" name="priorite" style="width: 10rem">
                                <option value="sante">Economique</option>
                                <option value="beaute">Beaute</option>
                                <option value="santeEtat">Le plus mauvais etat Economique</option>
                    ...
                    <div class="row ">
                        <div class="input-group mb-3  col-lg-12">
                            <label class="input-group-text" for="argent">Argent</label>
                            <input type="text" name="argent" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                       </div>
                    </div>
                    <div class="row ">
                         <div class="input-group mb-3 col-lg-12 ">
                            <label class="input-group-text" for="sceance">Date de Sceance</label>
                            <input type="date" name="daty" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                        </div>
                    </div>
                    <div class="col-12 ">
